"""
Mass property aggregation, used at every level (Section, Surface, Aircraft) of the
model.

Folds panels into a section, sections into a surface, and surfaces/point masses into
the aircraft.
"""
